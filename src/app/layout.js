...
export const metadata = {
  ...
  title: {
    default: "Music Tunes - Free Music Streaming & Download | Listen Online",
    template: "%s | Music Tunes",
  },
  description:
    "Stream and download your favorite songs for free on Music Tunes. Listen to Bollywood, Hindi, Punjabi, and international music. Create playlists, discover new artists, and enjoy high-quality music streaming.",
  keywords: [
    "music streaming",
    "free music download",
    "listen songs online",
  ...
  authors: [{ name: "Music Tunes" }],
  creator: "Music Tunes",
  publisher: "Music Tunes",
  icons: [{ rel: "icon", url: "/spotify.png" }],
  ...
  openGraph: {
    ...
    title: "Music Tunes - Free Music Streaming & Download",
    description:
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      name: "Music Tunes",
      description:
        "Stream and download your favorite songs for free on Music Tunes",
      url: siteUrl,
