...
export async function generateMetadata({ params }) {
  ...
  if (!artistData) {
    return {
      title: "Artist",
      description: "Listen to this artist on Music Tunes",
    };
  }
  ...
  return {
    ...
    description: `Listen to ${artistName} songs online for free. ${fanCount}. Download ${artistName} mp3 songs, albums, and top hits. Stream all ${artistName} music on Music Tunes.`,
    keywords: [
      artistName,
      `${artistName} songs`,
      `${artistName} mp3`,
    ...
    openGraph: {
      title: `${artistName} - Songs, Albums & Music | Music Tunes`,
